        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-200 hover:text-white">Domains</a></li>
          ...
          <div className="md:col-span-2">
            <h3 className="text-lg font-semibold mb-4">Connectify Like Minds</h3>
            <p className="text-gray-200">
              Made by learners, for learners. Join our community and grow together.
            </p>
          </div>
        </div>

        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-200">
          <p>&copy; {new Date().getFullYear()} Connectify Like Minds. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
